...
## Plot
fig = figure(figsize=(8.27, 11.68) )#, dpi=80)
...
#plt.savefig('title.pdf', bbox_inches=extent)

fig.subplots_adjust(bottom=0.0, top=1.0, left=0.0, right=1.0)

#tight_layout(pad=0.0, w_pad=0.0, h_pad=0.0)

savefig('title.png') #, bbox_inches='tight', pad_inches=0)
savefig('title.pdf') #, bbox_inches='tight', pad_inches=0)
